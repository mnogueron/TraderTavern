...
export class FinanceService {
  ...
  private toTickerDto(
    ...
    return new TickerDto(
      ...
      staticData.employees ?? null,
      staticData.fiscalYearEnd ?? null,
      staticData.mostRecentQuarter ?? null,
      technical?.rsi14 ?? null,
      technical?.macd ?? null,
      technical?.macdSignal ?? null,
      technical?.macdHistogram ?? null,
      technical?.bbUpper ?? null,
      technical?.bbMiddle ?? null,
      technical?.bbLower ?? null,
      technical?.bbWidth ?? null,
